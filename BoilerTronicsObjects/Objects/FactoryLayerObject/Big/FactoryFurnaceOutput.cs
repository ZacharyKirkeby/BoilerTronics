...
--- Internal object for FactoryFurnace ---
Should never be displayed on the actual tilemap and etc; only exists
to have unique "PickUp/Place" functionality depending on the slot that is being picked up

TODO: have more functionality
this is just copied from FactoryTestMachine for now
*/

namespace BoilerTronicsObjects.Objects.FactoryLayerObjects {

	public class FactoryFurnaceOutput : PlaceableObject, Runnable, Movable {
		...
		public FactoryFurnaceOutput(int OGX, int OGY, int altTitle = 0) 
