...
namespace BoilerTronicsObjects.Objects.FactoryLayerObjects {
	...
	public class IronBarObject : PlaceableObject, Movable {
		
		private static Vector2I objectAtlasPos = new Vector2I(2, 0);
		...
		public IronBarObject(int OGX, int OGY, int altTitle = 0) 
