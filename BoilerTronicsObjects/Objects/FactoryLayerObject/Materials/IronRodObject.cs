...
namespace BoilerTronicsObjects.Objects.FactoryLayerObjects {
	...
	public class IronRodObject : PlaceableObject, Movable {
		
		private static Vector2I objectAtlasPos = new Vector2I(0, 1);
		...
		public IronRodObject(int OGX, int OGY, int altTitle = 0) 
