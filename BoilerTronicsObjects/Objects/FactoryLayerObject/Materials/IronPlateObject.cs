...
namespace BoilerTronicsObjects.Objects.FactoryLayerObjects {
	...
	public class IronPlateObject : PlaceableObject, Movable {
		
		private static Vector2I objectAtlasPos = new Vector2I(3, 0);
		...
		public IronPlateObject(int OGX, int OGY, int altTitle = 0) 
